...
export function PortalFeedbackButton({
  ...
  return (
    <>
      ...
      {open ? (
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-[rgba(8,41,52,0.35)] p-3 sm:items-center sm:p-6">
          <div
            role="dialog"
            aria-modal="true"
            aria-labelledby="feedback-title"
            className="max-h-[92vh] w-full max-w-2xl overflow-y-auto rounded-lg border border-[color:var(--line)] bg-white p-5 shadow-[0_24px_80px_rgba(8,41,52,0.28)]"
          >
