  ...
  const visibleFamilies: Family[] = [
    {
      ...
      notes: "Prefers concise weekly progress notes after Saturday classes.",
  ...
  const visibleAdminTasks: AdminTask[] = [
    {
      ...
      details: "Include score trend, next homework, and next class reminder.",
    ...
    visibleNotes: [
      {
        ...
        visibility: "internal",
        summary: "Anika is ready for a timed reading section next class.",
        createdAt: now,
      },
    ],
    visibleResources: [
