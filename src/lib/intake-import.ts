  ...
  try {
    ...
    validRows.forEach((row, index) => {
      ...
      familyUpserts.set(familyId, {
        ...
        parent1_name: row.guardianName,
        parent1_email: row.guardianEmail,
        parent1_phone: row.guardianPhone || existingFamily?.phone || "Not provided",
        parent2_name: existingFamily?.parent2_name ?? null,
        parent2_email: existingFamily?.parent2_email ?? null,
        parent2_phone: existingFamily?.parent2_phone ?? null,
      ...
      familyByEmail.set(row.guardianEmail, {
        ...
        parent1_name: row.guardianName,
        parent1_email: row.guardianEmail,
        parent1_phone: row.guardianPhone || "Not provided",
        parent2_name: null,
        parent2_email: null,
        parent2_phone: null,
        email: row.guardianEmail,
      ...
      studentUpserts.set(studentId, {
        ...
        email: existingStudent?.email ?? null,
        ...
        external_id: existingStudent?.external_id ?? null,
        custom_fields: existingStudent?.custom_fields ?? {},
        demo,
      });
