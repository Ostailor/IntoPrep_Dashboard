...
> = {
  dashboard: {
    ...
    summary: "Live snapshot of the day across enrollment, teaching, and finance.",
    eyebrow: "Command center",
  },
  calendar: {
    title: "Instruction calendar",
    summary: "Time blocks, campus movement, and role assignments across the week.",
    eyebrow: "Schedule",
  },
  cohorts: {
    title: "Cohort map",
    summary: "Capacity, staffing, and academic momentum for each active cohort.",
    eyebrow: "Programs in motion",
  },
  attendance: {
    title: "Attendance board",
    summary: "Session-by-session attendance capture with same-day score context.",
    eyebrow: "Live teaching",
  },
  students: {
    title: "Student directory",
    summary: "Academic status, placement context, and support-ready student views.",
    eyebrow: "Student operations",
  },
  families: {
    title: "Family context",
    summary: "Guardian relationships, contact readiness, and support notes.",
    eyebrow: "Family operations",
  },
  programs: {
    title: "Program design",
    summary: "Seasonal tracks, pricing posture, and modality mix.",
    eyebrow: "Offerings",
  },
  academics: {
    title: "Academic analytics",
    summary: "Score movement, section-level performance, notes, and resources.",
    eyebrow: "Instruction intelligence",
  },
  messaging: {
    title: "Family messaging",
    summary: "Cohort-threaded communication with response urgency and ownership.",
    eyebrow: "Communication",
  },
  billing: {
    title: "Tuition visibility",
    summary: "Read-only finance visibility sourced from QuickBooks and manual records.",
    eyebrow: "Finance snapshot",
  },
  integrations: {
    title: "Integration watch",
    summary: "Sync health, fallback behavior, and import reliability.",
    eyebrow: "Data pipeline",
  },
  settings: {
    title: "Governance and roles",
    summary: "Access model, audit stance, and environment readiness.",
