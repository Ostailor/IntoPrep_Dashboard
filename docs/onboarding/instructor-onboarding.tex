...
\begin{itemize}
  ...
  \item update attendance in demo data once
  \item add a student instructional note in demo data
  \item add one session note in demo data
  \item create one follow-up flag in demo data
\end{itemize}
