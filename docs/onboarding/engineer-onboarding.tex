...
\begin{itemize}
  ...
  \item local development should stay on seeded or synthetic data
\end{itemize}
...
\begin{itemize}
  ...
  \item engineer could create a break-glass grant for ``family-bennett''
...
\begin{itemize}
  ...
  \item test one break-glass grant and revoke flow in the demo data
